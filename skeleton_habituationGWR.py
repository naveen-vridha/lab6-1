...
dec=0.7 # set weight decrement for habituation  # 0.7
...
forgetflag = True  # allows the model to simulate forgetting the new thing
...
for t in range(nTs):
    ...
    if t>3 and sum(x[t-4:t])==0 and v<stv and forgetflag:  # simulating forgetting
        v += (stv-v)*0.05
